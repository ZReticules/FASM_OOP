...
## Содержание  
1. [FASM_OOP](#FASM_OOP)  
   1.1. [Создание методов](#methods)  
   1.2. [Наследование и полиморфизм](#polymorphism)  
   1.3. [Вызов и процедур методов. Макрос @call](#@call)  
   1.4. [Обработка аргументов макроса @call](#@call_args)  
   1.5. [Обработчики методов](#meth_vectors)  
        1.5.1. [Виртуальне обьекты](#virt_obj)  
        1.5.2. [Инлайн методы: специальные возможности](#inline)  
   1.6. [@jret (для x64)](#@jret)  
   1.7. [Константные поля структур](#const)  
2. [DIALOGFORM](#dialogform)  
   2.1. [Макросы control и @control](#control)  
   2.2. [Макрос ShblDialog](#shbldialog)  
...
#### 1.5.1. Виртуальне обьекты<a name="virt_obj"></a>  
