...
; 		xor rdx, rdx
; 		xchg rdx, [_this+Graphics.\#nameField]
...
macro Graphics.destroyObject this, elemIndex{
	...
	xor rdx, rdx
	xchg rdx, [_this+Graphics.__hArr+elemIndex*8]
	@call [SelectObject]([_this+Graphics.__hArr+Graphics.hDC], rdx)
	@call [DeleteObject](rax)
}
...
macro Graphics.freeObject this, elemIndex{
	...
	xor rdx, rdx
	xchg rdx, [_this+Graphics.__hArr+elemIndex*8]
	@call [SelectObject]([_this+Graphics.hDC], rdx)
}
...
proc Graphics.create uses rbx, this, isBW
	virtObj .this:arg Graphics at rbx
	mov rbx, rcx
	mov [isBW], rdx
...
proc Graphics.selectObject, this, handle, elemIndex
	...
	mov [this], rcx
	mov [elemIndex], r8
	@call [SelectObject]([.this.hDC], rdx)
	mov rcx, [this]
	mov r8, [elemIndex]
